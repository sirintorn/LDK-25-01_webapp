...
const NavBar = (data: any) => {
  useEffect(() => {
    if(data.path){
      ...
      const selected = navigation.find(val => val.href == data.path);
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                ...
                <span className="text-gray-400 text-xs pt-3">{AppConfig.APP_VERSION}</span>
              </div>
            </div>
          </div>
                ...
                <div>
                  <MenuButton className="relative flex items-center rounded-full font-medium justify-center bg-gray-800 text-sm text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    ...
                    <img
                      ...
                      height={28}
                    />
                    <span>{data.user.display_name ? data.user.display_name : 'Username'}</span>
                  </MenuButton>
   ...
   */}
                  <MenuItem>
                    <a href="/sign-out" className="block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100">
                      Sign out
                    </a>
                  </MenuItem>
                </MenuItems>
  ...
  /*return (
    <>
    <nav className="NavBar bg-blue-600 flex justify-between">
      <h1 className="text-2xl font-semibold text-white">
        New Model Setup Line
      </h1>
    </nav>
    </>
  );*/
